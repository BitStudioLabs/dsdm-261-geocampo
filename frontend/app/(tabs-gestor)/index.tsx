...
const RECENT_ALERTS = [
  { id: '1', type: 'warning', message: 'Visita com localizacao divergente detectada', time: '2h atras' },
  { id: '2', type: 'info', message: 'Novo instrutor cadastrado: Ana Lima', time: '5h atras' },
  { id: '3', type: 'error', message: 'Possivel fraude: multiplas visitas no mesmo horario', time: '1d atras' },
];
        ...
        <View style={styles.statsGrid}>
          <View style={[styles.statCard, styles.statCardLarge]}>
            ...
            <View style={styles.statTrend}>
              <FontAwesome6 name="arrow-up" size={10} color={THEME.leafLight} />
          ...
          <View style={styles.actionsRow}>
            ...
            <TouchableOpacity style={styles.actionCard}>
              <View style={[styles.actionIcon, { backgroundColor: 'rgba(245,200,66,0.2)' }]}>
                <FontAwesome6 name="magnifying-glass-chart" size={18} color={THEME.gold} />
              </View>
              <Text style={styles.actionText}>Auditoria</Text>
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  statCard: { width: (SCREEN_W - 52) / 2, backgroundColor: THEME.cardBg, borderRadius: 18, padding: 16, borderWidth: 1, borderColor: 'rgba(77,200,90,0.12)' },
