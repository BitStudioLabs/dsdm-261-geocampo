...
const MENU_ITEMS = [
  ...
  { id: 'inst', icon: 'building', label: 'Instituicao', desc: 'Configuracoes institucionais' },
  ...
  { id: 'rel', icon: 'file-lines', label: 'Relatorios', desc: 'Configurar exportacoes' },
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Animated.View style={[styles.header, headerStyle]}>
          <View style={styles.avatarBox}>
            <FontAwesome6 name="user-tie" size={32} color={THEME.blue} />
          </View>
          <Text style={styles.userName}>Carlos Oliveira</Text>
          <Text style={styles.userEmail}>carlos.oliveira@instituicao.edu.br</Text>
        ...
        <View style={styles.instCard}>
          ...
          <View style={styles.instInfo}>
            <Text style={styles.instName}>Instituto Agronomico Regional</Text>
            <Text style={styles.instCode}>Codigo: IAR-2024-001</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  instCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: THEME.cardBg, borderRadius: 16, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(77,200,90,0.15)', gap: 14 },
